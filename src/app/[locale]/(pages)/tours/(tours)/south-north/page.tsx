      ...
      <div className='visibility_area'>
        <div>
          <div style={{position: 'relative', padding: "1%", backgroundColor: "#ffde4d"}}>
            <img
              src='/group-south-north/south-north-header.png'
              alt='South North Tour'
            />
          </div>
          <div className={styles.tours_background_color}>
            <h1 className={styles.tours_main_description_header}>{t('Tours.southNorthTour.title')} - {t('Tours.southNorthTour.duration')}</h1>
            <p className={styles.tours_main_description}>{t('Tours.southNorthTour.detail_description')}</p>
          </div>
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day1text')}</p>
            </div>
          </div>
          <div style={{position: 'relative'}}>
            <img
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day2text')}</p>
            </div>
          </div>
          <div style={{position: 'relative'}}>
            <img
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day3text')}</p>
            </div>
          </div>
          <div style={{position: 'relative'}}>
            <img
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day4text')}</p>
            </div>
          </div>
          <div style={{position: 'relative'}}>
            <img
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day5text')}</p>
            </div>
          </div>
          <div style={{position: 'relative'}}>
            <img
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day6text')}</p>
            </div>
          </div>
          <div style={{position: 'relative'}}>
            <img
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day7text')}</p>
            </div>
          </div>
          <div style={{position: 'relative'}}>
            <img
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day8text')}</p>
            </div>
            <div>
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day9text')}</p>
            </div>
          </div>
          <div style={{position: 'relative'}}>
            <img
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day10text')}</p>
            </div>
          </div>
          <div style={{position: 'relative'}}>
            <img
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day11text')}</p>
            </div>
          </div>
          <div style={{position: 'relative'}}>
            <img
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day12text')}</p>
            </div>
          </div>
          <div style={{position: 'relative'}}>
            <img
          ...
          <div style={{padding: "2%", backgroundColor: "#f6f5ff", marginBottom: "5%"}}>
            ...
            <div>
              <p className={styles.tour_left_column_text}>{t('SouthNorth.day13text')}</p>
            </div>
          </div>
